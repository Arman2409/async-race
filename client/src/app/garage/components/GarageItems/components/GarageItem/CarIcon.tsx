const CarIcon = ({ color, size = 50 }: { color?: string, size?: number }) => {
    return (
        <svg
            width={size}
            height={size}
            ...
            shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 313 512.52"><path stroke="#000" stroke-width=".5"
